...
<div class="content-wrapper" style="min-height: calc(100vh - 200px)">
    ...
    <form action="{{ route('dashboard.product.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="mx-15 mt-20">
        @csrf
        @method('PUT')
        <div class="row">
                            ...
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-12">
                                    @include('components.textarea.textarea',[
                                        ...
                                        'name'  => 'description',
                                        'default' => $product->getDescription(),
                                        'required' => true,
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="content" class="form-control" id="editor1" required>{{ str_ireplace($restrictedWords,'***',old('content',$product->getContent())) }}</textarea>
                                    @error('content')
            ...
            <div class="col-md-3 right-sidebar mt-42">
                <div class="bg-white widget">
                    ...
                    <div class="widget-body">
                        ...
                        'class' => 'form-control',
                        'label' => __('Image'),
                        'img' => Storage::url($product->getImage()),
                        'name' => 'image',
                        'default' => $product->getImage(),
                        ])
                    </div>
                    <div class="widget-body">
