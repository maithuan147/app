    ...
    <div class="content-wrapper" style="min-height: calc(100vh - 105px);margin-bottom:-30px">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ url('dashboard/role') }}">{{ __('Role') }}</a></li>
                <li class="active">{{ __('Create') }}</li>
            </ol>
        </section>
        <form method="POST" action="{{ route('dashboard.role.store') }}" class="mx-15 mt-20">
            @csrf
            @method('POST')
            <div class="row">
                <div class="col-md-9">
                        ...
                        <div class="form-body row">
                            ...
                            <div class="form-group col-md-12">
                                @include('components.textarea.textarea',[
                                    ...
                                    'required' => true,
                                    'default' => '',
                                    'placeholder' => __('Highest role in system')
                                ])
                            </div> 
                        </div>
                    </div>
                    ...
                    <div class="bg-white widget">
                        ...
                        <div class="widget-body role-label" style="margin-top:30px">
                            <input type="checkbox" class="js-cb-toggle-all" data-targets="target_cbs_id" id="target_cbs_id" value="all" name="permissions[]">
                            ...
                            <ul class="sidebar-menu border-left" data-widget="tree">
                                <li class="treeview ml-30">
                                    <input type="checkbox" class="js-cb-post-toggle-all" id="target_cbs_id" data-targets="target_cbs_post_id" value="post" name="permissions[]">
                                ...
                                <li class="treeview ml-30">
                                    <input type="checkbox" class="js-cb-catagory-toggle-all" id="target_cbs_id" data-targets="target_cbs_catagory_id" value="category" name="permissions[]">
                                    <a href="#" style="display:inline-block">
                                ...
                                <li class="treeview ml-30">
                                    <input type="checkbox" class="js-cb-tag-toggle-all" id="target_cbs_id" data-targets="target_cbs_tag_id" value="tag" name="permissions[]">
                                    <a href="#" style="display:inline-block">
